...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(ratio * 10):
            ...
            question = Question.objects.create(author=author, title=f'Title {i}', content=f'Content {i}')
        ...
        for i in range(ratio * 100):
            ...
            answer = Answer.objects.create(author=author, question=question, text=f'Answer {i}')
